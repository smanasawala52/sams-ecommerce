...
public class DocumentationConfiguration {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Sams", "http://www.sams.com", "");

	/**
	 * http://localhost:9193/swagger-ui.html#/ http://localhost:9193/v2/api-docs
	 */
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("Sams REST API",
				"API for Sams e-commerce. Contains public end points as well as private end points requiring basic authentication and remote authentication based on jwt bearer token. URL patterns containing /private/** use bearer token; those are authorized customer and administrators administration actions.",

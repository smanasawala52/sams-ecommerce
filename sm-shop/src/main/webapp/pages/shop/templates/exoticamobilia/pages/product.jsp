...
<%@ taglib uri="/WEB-INF/sams-tags.tld" prefix="sm" %> 
						...
						<div class="main col-md-12 no-left-padding no-right-padding">
							...
							<div class="col-md-4">
								...
								<div class="tab-content clear-style">
								  ...
								  <iframe src="https://www.facebook.com/plugins/share_button.php?href=<c:out value="${requestScope.CONFIGS['SHOP_SCHEME']}"/>%3A%2F%2F<c:out value="${requestScope.MERCHANT_STORE.domainName}"/><c:url value="/shop/${product.description.friendlyUrl}.html"/>&layout=button_count&size=large&mobile_iframe=true&appId=<c:out value="${requestScope.CONFIGS['sams.facebook-appid']}"/>&width=83&height=28" width="83" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
								  </p>
